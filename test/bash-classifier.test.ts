...
const vectors: Array<{ input: string; expected: "allow" | "block" }> = [
  ...
  { input: "fd --exclude node_modules useAttendeeBookingLanding", expected: "allow" },
  { input: "fd -- -xylophone", expected: "allow" },
  ...
  { input: "fd -x rm {}", expected: "block" },
  { input: "fd --exec sh -c 'touch /tmp/pwn' {}", expected: "block" },
  { input: "fd . -X sed -i 's/a/b/' {}", expected: "block" },
  { input: "fd --exec-batch=rm .", expected: "block" },
  { input: "fd -HIx rm {}", expected: "block" },
  { input: "fd -xrm {}", expected: "block" },
