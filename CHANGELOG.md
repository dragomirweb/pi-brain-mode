...
* **brain:** Add auto-review, delegation journal, and read-only runs ([3c757ab](https://github.com/dragomirweb/pi-brain-mode/commit/3c757ab653e40db420ca67750e2c24c5d523fb97))
...
* **brain:** Add per-repo quality gate configuration and optimize reviewer efficiency ([4f4b0a4](https://github.com/dragomirweb/pi-brain-mode/commit/4f4b0a4f9a6f4bf958d13e7644321f45ab29bd98))
...
* **brain:** Add worker isolation and intercom detachment handling ([13ad939](https://github.com/dragomirweb/pi-brain-mode/commit/13ad9394058844b4a7f9ae7fef513ac543f0b177))
* **brain:** Expand quality gates and strengthen delegation telemetry ([b95bf4a](https://github.com/dragomirweb/pi-brain-mode/commit/b95bf4a2ac607116d16aafb04bc2a4f1d81c71bc))
* **brain:** Migrate from event bridge to stable RPC API with schema validation ([bf078f0](https://github.com/dragomirweb/pi-brain-mode/commit/bf078f0ef3575c2f3913cc39bd16ba17188cac80))
* **brain:** Persist settings to file and make Brain Mode session-only ([9fa4113](https://github.com/dragomirweb/pi-brain-mode/commit/9fa41130e5728282e9ccd7fa219f92ae74a099bf))
